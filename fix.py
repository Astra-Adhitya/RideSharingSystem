            ...
            div.innerHTML = `
                <div class="card-info" style="width: 100%; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div style="display:flex; align-items:center; gap: 10px;">
                        ...
                        <button onclick="removeUser('${r.id}')" style="background:#ef4444; color:white; border:none; border-radius:4px; padding:4px 8px; font-size:11px; cursor:pointer;">Remove</button>
                    </div>
                </div>`;
            ...
            div.innerHTML = `
                <div class="card-info" style="width: 100%; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div style="display:flex; align-items:center; gap: 10px;">
                        ...
                        <button onclick="removeUser('${d.id}')" style="background:#ef4444; color:white; border:none; border-radius:4px; padding:4px 8px; font-size:11px; cursor:pointer;">Remove</button>
                    </div>
                </div>`;
...
# Replace removeUser with new methods
content = content.replace('''async function removeUser(userId) {
